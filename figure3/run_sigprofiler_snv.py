...
data = "/users/mathilde.meyenberg/sigprofiler/SNV2"

def main_function():
    sig.sigProfilerExtractor("vcf", "output", data, reference_genome="mm10", opportunity_genome='mm10', context_type = "default", exome = False,
